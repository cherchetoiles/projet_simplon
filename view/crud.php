...
<head>
    ...
    <link rel="stylesheet" href="/assets/script/Coloris-0.21.0/dist/coloris.min.css">
    <script src="/assets/script/Coloris-0.21.0/dist/coloris.min.js"></script>
...
<body class="h-full overflow-x-hidden overflow-y-scroll bg-gray-bg">
    ...
    <div class="relative z-0 flex w-full overflow-hidden">
        <nav class="fixed top-0 left-0 z-10 flex flex-col w-full h-screen p-8 transition-transform -translate-x-full bg-white md:max-w-xs font-body" id="crudSideBarContent">
            ...
            <div class="flex flex-col mx-auto mt-20 text-xl">
                <div class="flex items-center gap-3 py-3 text-gray-dark cursor-pointer" id="dashboard">
        ...
        <div class="relative z-0 flex flex-col items-center transition-all font-body grow lg:ml-10 lg:mr-2" id="mainCrudContent">
            <div class="w-full">
                <div class="flex flex-col items-center gap-2 mx-auto text-red lg:mx-0">
                    ...
                    <div class="flex items-center gap-2 text-4xl font-semibold text-black w-fit lg:w-full lg:justify-start" id="tabIndicator">
                    </div>
                </div> 
    ...
    <form class="z-20 font-body text-sm absolute right-1/2 top-0 translate-x-1/2 mx-auto w-full lg:w-4/5 xl:w-3/5 xl:min-w-[1200px] p-5 border-gray border border-solid hidden flex-col items-center rounded-[40px] lg:px-20 mt-10 py-2 bg-white" action="?action=addVideoTreat" method="POST" enctype="multipart/form-data" id="form-video" >
        ...
        <input type="submit" class="inline-block px-10 py-4 mx-auto mt-10 leading-none text-white rounded-lg bg-red cursor-pointer" id="submit_video" value="Envoyer la demande de post">
    </form>
    ...
    <!-- modal affichage description -->
    <div id="showDesc" class="hidden fixed flex flex-col right-1/2 pb-4  rounded-md bg-white w-[300px] translate-x-1/2 bottom-1/2 translate-y-1/2 padding-4 z-20">
        <div class="bg-red text-white py-2 rounded-t-md px-4">
            Description
        </div>
        <div class="absolute right-3 text-white text-xl top-0 cursor-pointer" onclick="openAndCloseModal(document.getElementById('showDesc'))">x</div>
        <span class="mx-4 block">

        </span>
    </div>
</body>
<script src="assets/script/script.js"></script>
<script src="assets/script/category_form.js"></script>
</html>